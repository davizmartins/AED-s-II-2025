...
class Game {
    ...
    public float getUScore() { return uScore; }
    public int getConq() { return conq; }
    ...
    public void setUScore(float uScore) { this.uScore = uScore; }
    public void setConq(int conq) { this.conq = conq; }
...
public class tp04 {
    ...
    String cleanDate = csvDate.replace("\"", "").trim();
        ...
        String monthNumber;
        switch (monthName) {
            case "Jan": monthNumber = "01"; break; case "Feb": monthNumber = "02"; break;
            case "Mar": monthNumber = "03"; break; case "Apr": monthNumber = "04"; break;
            case "May": monthNumber = "05"; break; case "Jun": monthNumber = "06"; break;
            case "Jul": monthNumber = "07"; break; case "Aug": monthNumber = "08"; break;
            case "Sep": monthNumber = "09"; break; case "Oct": monthNumber = "10"; break;
            case "Nov": monthNumber = "11"; break; case "Dec": monthNumber = "12"; break;
            default: monthNumber = "01";
        }
    ...
    public static void main(String[] args) {
        ...
        // ETAPA 1: Passagem inicial no arquivo para contar as linhas e definir o tamanho do array.
        ...
        // ETAPA 2: Segunda passagem para ler, processar cada linha e preencher o array.
        //Usei o bufferedreader para ler o arquivo, o que facilita a leitura linha a linha.
        try (BufferedReader arqReader = new BufferedReader(new FileReader(filePath))) {
            arqReader.readLine(); // Pula o cabeçalho.
            String linha;
            while ((linha = arqReader.readLine()) != null) {
                if (i < totalGames) {
                    // Realiza a lógica de tratamento da linha para o método parseGame.
        ...
        // ETAPA 3: Loop para ler entradas do pub.in e buscar jogos pelo ID.
