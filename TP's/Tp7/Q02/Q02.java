...
// Estrutura do No da Arvore de owners
class NoOw {
    public NoOw esq, dir;
    public int num;
...
class ArvoreOw {
    ...
    // Monta a arvore com a ordem fixa do enunciado
    ...
    // Insere um número na árvore de owners
    ...
    // Procura o nó cujo num é igual a chave
    ...
    // escolhe o NoOw pelo owners % 15 e insere pelo nome lá dentro
    public void inserirGame(Game g) {
        int chave = g.getOwners() % 15; // estimatedOwners mod 15
    ...
    // Funções para obeter o total de Comparações
...
// Estrutura do No da Arvore de Nomes
class NoNome {
...
public class Q02 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            java.io.FileWriter log = new java.io.FileWriter("885013_arvoreArvore.txt");
